...
const SLOVNIK = {
    cs: {
        ...
        /* --- Analýzy --- */
        'analyzy.nadpis': 'Zeptej se na kádr',
        'analyzy.popis': 'Čísla pod otázkou spočítala aplikace, ne model — průměry, rozdíly a pořadí jsou aritmetika a model by se v nich pletl. Model dostane tatáž hotová čísla a jeho prací je formulace.',
        'analyzy.otazka': 'Otázka',
        'analyzy.otazka.placeholder': 'Na co se chceš zeptat?',
        'analyzy.otazka.napoveda': 'Ptej se na to, co jde z hodnocení vyčíst. Model neví nic o zápasech, docházce ani o tom, co se stalo na tréninku.',
        'analyzy.zeptat': 'Zeptat se',
        'analyzy.zeptat.tip': 'Pošle otázku i spočítané podklady jazykovému modelu',
        'analyzy.priklady': 'Nemáš-li otázku po ruce, zkus některou z těchto:',
        ...
        'analyzy.vypnuto': 'Otázky modelu jsou vypnuté. Zapínají se v Nastavení zvlášť od příkazového řádku, protože posílají ven známky a slovní posudky konkrétních hráčů. Souhrny níž se počítají v aplikaci a jsou dostupné vždycky.',
        ...
        'prikaz.nerozumim': 'Tomuhle nerozumím. Zkus jméno hráče, například „Robin" nebo „porovnej Robina a Ferdu".',
        'prikaz.napoveda': 'Napiš jméno hráče nebo povel',
        'prikaz.spustit': 'Provést',
        'prikaz.spustit.tip': 'Vyhledá hráče v kádru a nabídne, co s ním',
    ...
    en: {
        ...
        /* --- Analyses --- */
        'analyzy.nadpis': 'Ask about the squad',
        'analyzy.popis': 'The numbers below the question are computed by the app, not the model — averages, gaps and ordering are arithmetic and a model would get them wrong. The model receives the same finished numbers; its job is the wording.',
        'analyzy.otazka': 'Question',
        'analyzy.otazka.placeholder': 'What would you like to ask?',
        'analyzy.otazka.napoveda': 'Ask what can be read from the evaluations. The model knows nothing about matches, attendance or what happened at training.',
        'analyzy.zeptat': 'Ask',
        'analyzy.zeptat.tip': 'Sends the question and the computed data to the language model',
        'analyzy.priklady': 'No question at hand? Try one of these:',
        ...
        'analyzy.vypnuto': 'Questions to the model are switched off. They are enabled separately from the command bar in Settings, because they send out scores and written assessments of individual players. The summaries below are computed in the app and are always available.',
        ...
        'prikaz.nerozumim': 'I do not understand that. Try a player name, e.g. “Robin” or “compare Robin and Ferda”.',
        'prikaz.napoveda': 'Type a player name or a command',
        'prikaz.spustit': 'Go',
        'prikaz.spustit.tip': 'Finds the player in the squad and offers what to do',
