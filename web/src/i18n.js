...
const SLOVNIK = {
    cs: {
        ...
        'listy.kdo.popis': 'Řádek na každou přiřazenou šablonu — je vidět, která ještě nemá hodnocení. Zaškrtnutím se vybírá celý hráč.',
    ...
    en: {
        ...
        'listy.kdo.popis': 'One row per assigned template, so you can see which one is still missing an evaluation. The tick box selects the whole player.',
