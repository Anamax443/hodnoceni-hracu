...
const SLOVNIK = {
    cs: {
        ...
        'uprava.jinaSablona': 'Přepnul jsi na jinou šestici os, než má upravovaná verze — známky se musí zadat znovu.',
    ...
    en: {
        ...
        'uprava.jinaSablona': 'You switched to a different set of axes than the edited version uses — the scores have to be entered again.',
