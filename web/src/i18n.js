...
const SLOVNIK = {
    cs: {
        ...
        'login.kdo': 'Kdo jsi',
        'login.kdo.napoveda': 'Přihlašovací jméno. Necháš-li prázdné, použije se staré společné heslo.',
        ...
        'login.obnova.popis': 'Napiš svoje přihlašovací jméno. Odkaz na nastavení nového hesla ti přijde na Telegram nebo e-mail, které máš u sebe vyplněné. Odpověď je vždycky stejná, ať se nedá zjišťovat, kdo má účet.',
    ...
    en: {
        ...
        'login.kdo.napoveda': 'Your sign-in name. Leave empty to use the old shared password.',
        ...
        'login.obnova.popis': 'Enter your sign-in name. The link for setting a new password goes to the Telegram or e-mail you have on file. The answer is always the same, so nobody can probe who has an account.',
